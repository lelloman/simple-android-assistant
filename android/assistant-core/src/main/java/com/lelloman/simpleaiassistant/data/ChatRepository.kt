...
interface ChatRepository {
    ...
    val restartChoice: StateFlow<com.lelloman.simpleaiassistant.engine.RestartChoice?>
    suspend fun cancel()
    suspend fun confirmRestart(modeId: String, revision: Long)
    suspend fun dismissRestart()
     ...
     * Full history is retained; automatic summarization only changes model context.
     *
